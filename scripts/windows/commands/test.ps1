...
.DESCRIPTION
Builds the test container and runs flutter test --coverage plus the
coverage gate. The coverage report is written to ./coverage/lcov.info.
...
.EXAMPLE
scripts/windows/commands/test.ps1
scripts/windows/commands/test.ps1 -MinCoverage 80
scripts/windows/commands/test.ps1 -Force
#>
